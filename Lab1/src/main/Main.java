...
public class Main {
	...
	public static boolean addDepartment(String newName) throws EmptyGuildNameException {
	...
	public static void removeDepartmentFromDatabase(int index) {
		...
		Department unassignedDepartment = getUnassignedDepartment();
		ArrayList<GuildMember> removedMembers = myDatabase.removeDepartment(index);
		unassignedDepartment.addMultipleMembers(removedMembers);
		System.out.println("Department removed. " + removedMembers.size() + " member(s) added to Unassigned Department.");
	}
